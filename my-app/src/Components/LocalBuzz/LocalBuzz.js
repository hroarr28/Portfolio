    ...
    <div className='overallContainer'>
      <div className='project1Container'>
        ...
        <div className='TechStack1'>
          <p className='MongoDB1'>MongoDB</p>
          <p className='Express1'>Express</p>
          <p className='React1'>React</p>
          <p className='NodeJS1'>Node.js</p>

          <p className='ReactRouter1'>React Router</p>
          <p className='TestingLibrary1'>Testing Library</p>
        </div>
        ...
        <p>
          ...
          important to create a robust manifesto that allowed us to work
          together effectively. We made sure to take on an agile approach and
          made changes to the project based off frequent feedback.
        </p>
        ...
        <p>
          {" "}
          In today's fast-paced and digital world, fostering meaningful
          community engagement and connection can be a challenge. People often
          feel disconnected from their local communities, lacking opportunities
          to connect, collaborate, and contribute to the betterment of their
          neighbourhoods.{""}
        </p>
        ...
        <p className='p1'>
          ...
          local experience. Our app enables you to effortlessly discover
          exciting events happening in your area using geolocation. Whether you
          prefer scrolling through or searching for specific events, LocalBuzz
          has got you covered. You can join events that pique your interest and
          even create your own events to bring people together.{""}
        </p>
        ...
        <p className='p3'>
          {" "}
          Experience the power of community engagement with LocalBuzz and unlock
          a world of opportunities right in your neighborhood.{" "}
        </p>

        <h2>What I Learned</h2>
        <div className='learnedList'>
          <p className='list'>
            <span className='listIcon'></span> A deeper understanding of React
          ...
          <p className='list'>
            <span className='listIcon'></span> The power of collaboration within
            a great team
          </p>
          <p className='list'>
            <span className='listIcon'></span> Utilizing MongoDB for creating
          ...
          <p className='list'>
            <span className='listIcon'></span> Effective use of Trello to
            complete tasks
          </p>
          <p className='list'>
          ...
          <p className='list'>
            <span className='listIcon'></span> Implementing responsive design
            for a seamless user experience across different devices
          </p>
          <p className='list'>
            <span className='listIcon'></span> Writing unit tests for code
